  ...
  return (
    <div style={{ padding: "0 20px 40px" }}>
      ...
      >
        ...
        <p style={{ fontSize: 14, lineHeight: 1.6, color: colors.ink, margin: "0 0 14px" }}>
        ...
        <p style={{ fontSize: 13, color: colors.muted, margin: 0 }}>
          ...
          une option pour ceux qui veulent aller plus loin. Ton statut membre est activé
          manuellement une fois le paiement reçu.
        </p>
      </div>
      ...
      {!user ? (
        <>
          <p style={{ fontSize: 13, color: colors.muted, marginBottom: 14 }}>
            Connecte-toi d'abord pour qu'on puisse relier ton paiement à ton compte.
          </p>
          <button
